...
export interface WidgetAction extends CustomActionDescriptor {
    ...
    dialogWidth?: number;
    dialogHeight?: number;
    dialogMovable?: boolean;
    dialogAutoHideHeader?: boolean;
    setEntityId?: boolean;
...
export interface WidgetConfig {
    ...
    runtimeVisibility?: WidgetRuntimeVisibility;
    [key: string]: any;
}
export interface WidgetRuntimeVisibility {
    enabled: boolean;
    visibilityAction?: any;
}
/**
 * Visual ("style") subset of WidgetConfig — the type-agnostic appearance fields
 * shared by every widget regardless of type. Used by copy/paste style and the
 * multi-widget common-style edit. `widgetCss` is intentionally excluded: it is
 * injected as a separate <style> element and needs a widget re-init to apply.
 */
export declare const widgetStyleConfigKeys: Array<keyof WidgetConfig>;
