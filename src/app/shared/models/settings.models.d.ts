...
export interface CustomHttpSmsProviderConfiguration {
    method?: string;
    url?: string;
    bodyTemplate?: string;
    contentType?: string;
...
export type SmsProviderConfigurations = Partial<SmppSmsProviderConfiguration> & AwsSnsSmsProviderConfiguration & TwilioSmsProviderConfiguration & Partial<CustomHttpSmsProviderConfiguration>;
