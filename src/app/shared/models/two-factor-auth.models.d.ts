...
export type TwoFactorAuthProviderConfig = Partial<TotpTwoFactorAuthProviderConfig | SmsTwoFactorAuthProviderConfig | EmailTwoFactorAuthProviderConfig | TelegramTwoFactorAuthProviderConfig | WhatsappTwoFactorAuthProviderConfig>;
export type TwoFactorAuthProviderConfigForm = Partial<TotpTwoFactorAuthProviderConfig | SmsTwoFactorAuthProviderConfig | EmailTwoFactorAuthProviderConfig | TelegramTwoFactorAuthProviderConfig | WhatsappTwoFactorAuthProviderConfig> & TwoFactorAuthProviderFormConfig;
...
export interface TelegramTwoFactorAuthProviderConfig {
    providerType: TwoFactorAuthProviderType;
    verificationCodeLifetime: number;
}
export interface WhatsappTwoFactorAuthProviderConfig {
    providerType: TwoFactorAuthProviderType;
    verificationCodeLifetime: number;
}
...
export interface TelegramTwoFactorAuthAccountConfig extends GeneralTwoFactorAuthAccountConfig {
    chatId?: string;
}
export interface WhatsappTwoFactorAuthAccountConfig extends GeneralTwoFactorAuthAccountConfig {
    phoneNumber?: string;
}
...
export type TwoFactorAuthAccountConfig = TotpTwoFactorAuthAccountConfig | SmsTwoFactorAuthAccountConfig | EmailTwoFactorAuthAccountConfig | TelegramTwoFactorAuthAccountConfig | WhatsappTwoFactorAuthAccountConfig | BackupCodeTwoFactorAuthAccountConfig;
