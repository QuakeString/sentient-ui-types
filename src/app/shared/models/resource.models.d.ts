...
export declare const ST_IMAGE_PREFIX = "st-image;";
export declare const ST_RESOURCE_PREFIX = "st-resource;";
...
export declare const removeStImagePrefix: (url: string) => string;
export declare const removeStResourcePrefix: (url: string) => string;
export declare const removeStImagePrefixFromUrls: (urls: string[]) => string[];
export declare const prependStImagePrefix: (url: string) => string;
export declare const prependStImagePrefixToUrls: (urls: string[]) => string[];
export declare const prependStResourcePrefix: (url: string) => string;
