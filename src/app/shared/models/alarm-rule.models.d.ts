...
/**
 * The wire-shape returned by `/api/alarm/rule/*` is a `CalculatedField`
 * with `type='ALARM'`. The backend exposes them as a separate API
 * surface, but storage stays unified. This alias keeps UI code
 * readable ("an alarm rule") without introducing a parallel type.
 */
export type AlarmRuleDefinition = CalculatedField;
