...
export declare enum DebugEventType {
    ...
    DEBUG_ANALYTICS_PIPELINE = "DEBUG_ANALYTICS_PIPELINE"
}
...
export interface AnalyticsPipelineEventBody extends BaseEventBody {
    nodeId: string;
    nodeType: string;
    type: string;
    relationType: string;
...
export type EventBody = ErrorEventBody & LcEventEventBody & StatsEventBody & DebugRuleNodeEventBody & DebugRuleChainEventBody & CalculatedFieldEventBody & AnalyticsPipelineEventBody;
