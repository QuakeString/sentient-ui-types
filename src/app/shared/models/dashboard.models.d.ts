...
export interface DashboardInfo extends BaseData<DashboardId>, HasTenantId, HasVersion, ExportableEntity<DashboardId> {
    tenantId?: TenantId;
    /** Owner: the customer this dashboard belongs to (absent = tenant-owned).
     *  Resolved server-side into customerTitle for the table's Customer column. */
    customerId?: CustomerId;
    customerTitle?: string;
    customerIsPublic?: boolean;
    title?: string;
    image?: string;
    /** @deprecated Use entity group membership for access control instead of assignedCustomers */
...
export declare const SCADA_DEFAULT_LAYERS = 15;
export declare const SCADA_LAYER_STRIDE = 10000;
export declare const SCADA_LAYER_MAX_ZINDEX = 999;
...
export interface DashboardSetup extends Dashboard {
    /** @deprecated No longer used — owner is set via entity group membership */
    assignedCustomerIds?: Array<string>;
}
/** @deprecated Use entity group membership for access control */
