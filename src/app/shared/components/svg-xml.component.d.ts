...
export declare class SvgXmlComponent implements OnInit, OnDestroy, ControlValueAccessor, Validator {
    ...
    constructor(elementRef: ElementRef, utils: UtilsService, translate: TranslateService, store: Store<AppState>, raf: RafService, cd: ChangeDetectorRef, themeService: ThemeService);
    ngOnInit(): void;
    ngOnDestroy(): void;
