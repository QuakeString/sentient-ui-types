import { ChangeDetectorRef, DestroyRef, ElementRef, OnChanges, OnDestroy, OnInit, SimpleChanges, ViewContainerRef } from '@angular/core';
...
export declare class TimewindowComponent implements ControlValueAccessor, OnInit, OnChanges, OnDestroy {
    private overlay;
    private translate;
    private timeService;
