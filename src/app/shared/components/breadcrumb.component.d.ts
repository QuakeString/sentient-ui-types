...
export declare class BreadcrumbComponent implements OnInit, OnDestroy {
    ...
    constructor(router: Router, activatedRoute: ActivatedRoute, broadcast: BroadcastService, activeComponentService: ActiveComponentService, cd: ChangeDetectorRef, translate: TranslateService, menuService: MenuService, customerNavService: CustomerNavigationService, store: Store<AppState>, utils: UtilsService);
    ngOnInit(): void;
    ngOnDestroy(): void;
    private lastChild;
    ...
    private fullscreenHomeBreadcrumb;
