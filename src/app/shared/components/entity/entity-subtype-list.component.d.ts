...
export declare class EntitySubTypeListComponent implements ControlValueAccessor, OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(broadcast: BroadcastService, translate: TranslateService, alarmService: AlarmService, alarmRulesService: AlarmRulesService, utils: UtilsService, fb: FormBuilder, entityService: EntityService);
