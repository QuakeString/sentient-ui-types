...
export declare class TbScriptLangComponent extends PageComponent implements ControlValueAccessor, OnInit {
    ...
    scriptLangOptions: ToggleHeaderOption[];
    disabled: boolean;
    private propagateChange;
    constructor(store: Store<AppState>, fb: UntypedFormBuilder, destroyRef: DestroyRef, translate: TranslateService);
    ngOnInit(): void;
    onScriptLangChange(value: ScriptLanguage): void;
