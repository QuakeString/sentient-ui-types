...
export declare class CreatePasswordComponent extends PageComponent implements OnInit, OnDestroy {
    ...
    constructor(store: Store<AppState>, route: ActivatedRoute, authService: AuthService, translate: TranslateService, fb: UntypedFormBuilder, themeService: ThemeService);
    ngOnInit(): void;
    ngOnDestroy(): void;
