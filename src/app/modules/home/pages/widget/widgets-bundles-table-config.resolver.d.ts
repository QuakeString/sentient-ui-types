...
export declare class WidgetsBundlesTableConfigResolver {
    ...
    constructor(store: Store<AppState>, dialogService: DialogService, widgetsService: WidgetService, translate: TranslateService, importExport: ImportExportService, datePipe: DatePipe, router: Router, permissionService: PermissionService);
