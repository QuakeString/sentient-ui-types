...
export declare class RuleChainPageComponent extends PageComponent implements AfterViewInit, OnInit, OnDestroy, HasDirtyFlag, ISearchableComponent, AfterViewChecked {
    ...
    ruleChainGraph: ElementRef<HTMLElement>;
    ...
    private panActive;
    private panStart;
    private readonly panDownHandler;
    private panMoveUnlisten;
    private panUpUnlisten;
    private setupGraphPan;
    private onGraphPanStart;
    private onGraphPanMove;
    private endGraphPan;
