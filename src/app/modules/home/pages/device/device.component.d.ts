...
export declare class DeviceComponent extends EntityComponent<DeviceInfo> {
    ...
    constructor(store: Store<AppState>, translate: TranslateService, entityValue: DeviceInfo, entitiesTableConfigValue: EntityTableConfig<DeviceInfo>, fb: UntypedFormBuilder, cd: ChangeDetectorRef, destroyRef: DestroyRef, entityGroupService: EntityGroupService);
    ngOnInit(): void;
    hideDelete(): boolean;
