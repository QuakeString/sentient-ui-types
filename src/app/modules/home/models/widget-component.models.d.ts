...
import { WidgetExportData } from '@core/services/widget-data-export.service';
...
export declare class WidgetContext {
    ...
    /** Optional hook for widgets whose exportable data is not in `data`/`latestData`
     *  (recipe table, alarm table). Returns a ready-to-write table or null. */
    customDataExport?: () => WidgetExportData | null | undefined;
