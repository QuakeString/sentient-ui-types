...
export declare class EventContentDialogComponent extends DialogComponent<EventContentDialogData> implements OnInit, OnDestroy {
    ...
    constructor(store: Store<AppState>, router: Router, data: EventContentDialogData, dialogRef: MatDialogRef<EventContentDialogComponent>, renderer: Renderer2, themeService: ThemeService);
    ngOnInit(): void;
    ngOnDestroy(): void;
