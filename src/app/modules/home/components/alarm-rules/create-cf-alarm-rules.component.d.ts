...
export declare class CreateCfAlarmRulesComponent implements ControlValueAccessor, Validator {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CreateCfAlarmRulesComponent, "tb-create-cf-alarm-rules", never, { "disabled": { "alias": "disabled"; "required": false; }; "arguments": { "alias": "arguments"; "required": false; }; "testScript": { "alias": "testScript"; "required": false; }; }, {}, never, never, false, never>;
}
