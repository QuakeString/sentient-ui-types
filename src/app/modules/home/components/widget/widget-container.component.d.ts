...
export declare enum WidgetComponentActionType {
    ...
    EXPORT = 5,
    REMOVE = 6,
    REPLACE_REFERENCE_WITH_WIDGET_COPY = 7,
    ROTATE = 8
}
...
export declare class WidgetContainerComponent extends PageComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
    ...
    constructor(store: Store<AppState>, cd: ChangeDetectorRef, renderer: Renderer2, container: ViewContainerRef, dashboardUtils: DashboardUtilsService, widgetDataExportService: WidgetDataExportService, utils: UtilsService);
    exportData(format: WidgetDataExportFormat): void;
    ngOnInit(): void;
    ngAfterViewInit(): void;
    ngOnChanges(changes: SimpleChanges): void;
    private editTooltipInitStarted;
    private initEditTooltipLazy;
    ngOnDestroy(): void;
