...
export declare class MapLayerRowComponent implements ControlValueAccessor, OnInit {
    ...
    constructor(fb: UntypedFormBuilder, translate: TranslateService, utils: UtilsService, popoverService: TbPopoverService, renderer: Renderer2, viewContainerRef: ViewContainerRef, cd: ChangeDetectorRef, destroyRef: DestroyRef);
    ngOnInit(): void;
