...
export declare class MultipleInputWidgetComponent extends PageComponent implements OnInit, OnDestroy {
    ...
    constructor(store: Store<AppState>, elementRef: ElementRef, ngZone: NgZone, overlay: Overlay, viewContainerRef: ViewContainerRef, utils: UtilsService, fb: UntypedFormBuilder, attributeService: AttributeService, translate: TranslateService, sanitizer: DomSanitizer, cd: ChangeDetectorRef, dialog: MatDialog);
    ngOnInit(): void;
    ngOnDestroy(): void;
