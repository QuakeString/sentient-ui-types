...
export declare class ScadaSymbolWidgetComponent implements OnInit, AfterViewInit, OnDestroy, ScadaSymbolObjectCallbacks {
    ...
    ngOnDestroy(): void;
    applyOrientation(rotation: number, flipHorizontal: boolean, flipVertical: boolean): void;
    private static readonly CONTENT_PROP_TYPES;
    contentPropertyIds(): string[];
    applyStyleUpdate(scadaStyle: {
        properties?: {
            [id: string]: any;
        };
        background?: any;
