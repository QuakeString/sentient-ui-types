...
export declare const latestChartTooltipFormatter: (renderer: Renderer2, settings: LatestChartTooltipSettings, params: CallbackDataParams, total: number, dataItems: LatestChartDataItem[], darkMode?: boolean) => null | HTMLElement;
