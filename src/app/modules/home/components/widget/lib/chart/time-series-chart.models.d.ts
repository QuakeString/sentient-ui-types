...
export declare const createTimeSeriesVisualMapOption: (settings: TimeSeriesChartVisualMapSettings, selectedRanges: {
    [key: number]: boolean;
}, darkMode?: boolean) => VisualMapComponentOption;
...
export declare const updateDarkMode: (options: EChartsOption, xAxisList: TimeSeriesChartXAxis[], yAxisList: TimeSeriesChartYAxis[], dataItems: TimeSeriesChartDataItem[], darkMode: boolean, settings?: TimeSeriesChartSettings, thresholdItems?: TimeSeriesChartThresholdItem[]) => EChartsOption;
export {};
