...
export declare const barChartWithLabelsTimeSeriesKeySettings: (settings: BarChartWithLabelsWidgetSettings, decimals: number, darkMode?: boolean) => DeepPartial<TimeSeriesChartKeySettings>;
