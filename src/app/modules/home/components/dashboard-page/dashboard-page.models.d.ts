...
export interface IDashboardController {
    ...
    copyWidgets($event: Event, layoutCtx: DashboardPageLayoutContext, widgets: Widget[]): any;
    saveDashboard(closeEditMode?: boolean): any;
    removeWidget($event: Event, layoutCtx: DashboardPageLayoutContext, widget: Widget): any;
    removeWidgets($event: Event, layoutCtx: DashboardPageLayoutContext, widgets: Widget[]): any;
    ...
    copyWidgetsReference($event: Event, layoutCtx: DashboardPageLayoutContext, widgets: Widget[]): any;
    ...
    changeWidgetLayer(layoutCtx: DashboardPageLayoutContext, widget: Widget, mode: 'front' | 'back' | 'forward' | 'backward'): any;
    moveWidgetToLayer(layoutCtx: DashboardPageLayoutContext, widget: Widget): any;
    undo(): any;
    redo(): any;
    pushUndoSnapshot(): any;
    beginWidgetChange(): any;
    commitWidgetChange(): any;
