...
export declare class EntitiesTableComponent extends PageComponent implements IEntitiesTableComponent, AfterViewInit, OnInit, OnChanges, OnDestroy {
    ...
    addEnabled(): boolean;
    clearSelection(): void;
    updateData(closeDetails?: boolean, reloadEntity?: boolean, silent?: boolean): void;
    private dataLoaded;
    ...
    sparkLineData(entity: BaseData<HasId>, column: EntityColumn<BaseData<HasId>>): number[];
    sparkLineTotal(entity: BaseData<HasId>, column: EntityColumn<BaseData<HasId>>): number;
    ...
    isGroupActionEnabled(actionDescriptor: GroupActionDescriptor<BaseData<HasId>>, entities: BaseData<HasId>[]): boolean;
