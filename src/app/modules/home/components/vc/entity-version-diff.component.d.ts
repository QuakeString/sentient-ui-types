...
export declare class EntityVersionDiffComponent extends PageComponent implements OnInit, OnDestroy {
    ...
    hasPrevious: boolean;
    diffCount: number;
    constructor(store: Store<AppState>, entitiesVersionControlService: EntitiesVersionControlService, cd: ChangeDetectorRef, renderer: Renderer2, elementRef: ElementRef, viewContainerRef: ViewContainerRef, popoverService: TbPopoverService, themeService: ThemeService);
    ngOnInit(): void;
