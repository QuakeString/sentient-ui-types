...
export declare class LogConfigComponent extends RuleNodeConfigurationComponent {
    private fb;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<LogConfigComponent, "tb-action-node-log-config", never, {}, {}, never, never, false, never>;
}
