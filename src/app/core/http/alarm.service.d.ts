...
export declare class AlarmService {
    ...
    assignAlarm(alarmId: string, assigneeId: string, config?: RequestConfig): Observable<AlarmInfo>;
    unassignAlarm(alarmId: string, config?: RequestConfig): Observable<AlarmInfo>;
