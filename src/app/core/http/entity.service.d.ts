...
export declare class EntityService {
    ...
    getEntitiesByNameFilter(entityType: EntityType, entityNameFilter: string, pageSize: number, subType?: string, config?: RequestConfig, customerId?: string): Observable<Array<BaseData<EntityId>>>;
    ...
    getEntityKeys(entityId: EntityId, query: string, type: DataKeyType, config?: RequestConfig, attributeScope?: AttributeScope): Observable<Array<string>>;
