...
export declare class DeviceService {
    ...
    getDevicesByTenant(tenantId: string, pageLink: PageLink, config?: RequestConfig): Observable<PageData<DeviceInfo>>;
    ...
    changeDeviceOwner(deviceId: string, customerId: string, config?: RequestConfig): Observable<Device>;
    removeDeviceOwner(deviceId: string, config?: RequestConfig): Observable<Device>;
