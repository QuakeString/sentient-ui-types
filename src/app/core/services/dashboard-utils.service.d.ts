...
export declare class DashboardUtilsService {
    ...
    addWidgetToLayout(dashboard: Dashboard, targetState: string, targetLayout: DashboardLayoutId, widget: Widget, originalColumns?: number, originalSize?: WidgetSize, row?: number, column?: number, breakpoint?: string, activeLayer?: number): void;
    ...
    getOriginalPosition(dashboard: Dashboard, sourceState: string, sourceLayout: DashboardLayoutId, widget: Widget, breakpointId: BreakpointId): {
        row: number;
        col: number;
        layer?: number;
    } | null;
