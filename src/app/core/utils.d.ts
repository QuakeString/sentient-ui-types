...
export declare function substituteStateKeyParams(text: string, stateParams: {
    [key: string]: any;
}, skipReservedLabelParams?: boolean): string;
...
export declare function isTauriApp(): boolean;
export declare function tauriBackendUrl(): string;
export declare function backendBaseUrl(): string;
